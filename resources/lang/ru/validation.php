...
return [
    ...
    */
    ...
    'confirmed' => ':Attribute не совпадает с полем подтверждения пароля.',
    ...
    'max' => [
        ...
        'file' => ':Attribute должно быть не более чем :max Кб.',
    ...
    'regex' => ':Attribute не корректен. Допускаются латинские символы и цифры без пробелов.',
    'required' => ':Attribute является обязательным.',
    'required_if' => 'The :attribute field is required when :other is :value.',
    'required_unless' => 'The :attribute field is required unless :other is in :values.',
    'required_with' => 'Поле :attribute обязательно, когда :values представлен.',
