                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="content" name="content"
                                                  readonly>@foreach($dictionary['excerpts'] as $excerpt){{$excerpt['excerpt']}}{{$loop->last ? "" : "\n"}}@endforeach</textarea>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                            <div class="my-3 p-3 rounded comments">
                                                <h6 class="border-bottom pb-2 mb-0">Недавние комментарии <i class="fa-solid fa-comment-dots"></i></h6>
                                    ...
                                    <div class="col-12">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="comment" placeholder="Написать комментарий"
                                                   aria-label="comment">
                                            <button type="submit" class="btn btn-secondary send-comment" data-id="{{$dictionary->id}}" data-uri="{{route('comment.store')}}" data-method="POST">Написать</button>
                                            <button type="submit" class="btn btn-secondary send-update-comment d-none">Изменить</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
