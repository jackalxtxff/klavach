                        ...
                        <div class="card-body">
                            <div class="d-grid mb-2">
                                <p class="m-0">
                                    ...
                                    <a href="{{route('dictionaries.create')}}" class="btn btn-outline-dark"> Создать словарь</a>
                                </p>
                            </div>
                                ...
                                <div class="list-group mx-0 mb-2">
                                    ...
                                    <label class="list-group-item d-flex gap-2">
                                        <input class="form-check-input flex-shrink-0" type="radio" name="chapter"
                                               ...
                                               @if(request()->has('chapter') && request()->chapter == "my") checked @endif>
                                        <span>
                                                                    Созданные мной
                                                                </span>
                                    </label>
                                    <label class="list-group-item d-flex gap-2">
                                        <input class="form-check-input flex-shrink-0" type="radio" name="chapter"
                                               ...
                                               data-uri="{{route('dictionaries.index')}}"
                                               @if(request()->has('chapter') && request()->chapter == "favs") checked @endif>
                                        <span>
                                                                    Используемые мной
                                                                </span>
                                    </label>
                                ...
                                <div class="list-group mx-0">
                                    ...
                                    <label class="list-group-item d-flex gap-2">
                                        <input class="form-check-input flex-shrink-0" type="radio" name="sort"
                                               ...
                                               data-uri="{{route('dictionaries.index')}}"
                                               @if(request()->has('sort') && request()->sort == 'grade') checked @endif>
                                        <span>
                                                                    По оценкам
                                                                </span>
                                    </label>
                                    <label class="list-group-item d-flex gap-2">
                                        <input class="form-check-input flex-shrink-0" type="radio" name="sort"
                                               ...
                                               data-uri="{{route('dictionaries.index')}}"
                                               @if(request()->has('sort') && request()->sort == 'diff') checked @endif>
                                        <span>
                                                                    По сложности
                                                                </span>
                                    </label>
